...
namespace Task.DAL.Migrations
{
    ...
    [Migration("20230821005122_fluent2")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Task.EntityLayer.Entities.UrunSiparis", b =>
                {
                    b.Property<int>("SiparisId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Task.EntityLayer.Entities.UrunSiparis", b =>
                {
                    b.HasOne("Task.EntityLayer.Entities.Siparis", "Siparis")
                        .WithMany()
                        .HasForeignKey("SiparisId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Task.EntityLayer.Entities.Urun", "Urun")
                        .WithMany()
